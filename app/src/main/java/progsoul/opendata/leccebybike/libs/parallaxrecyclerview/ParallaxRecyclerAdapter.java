package progsoul.opendata.leccebybike.libs.parallaxrecyclerview;

/**
 * Created by ProgSoul on 04/04/2015.
 */
...
public class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setParallaxHeader(View header, final RecyclerView view) {
        ...
        final float scale = header.getContext().getResources().getDisplayMetrics().density;
        int dpHeightInPx = (int) (70 * scale);

        mHeader.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpHeightInPx));
